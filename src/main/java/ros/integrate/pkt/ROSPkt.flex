...
FIRST_STRING_4FRAG=[^\n\ =\#]
LAST_STRING=[^\n\ ]
END_STR_SEQ={CONST_STRING}*{LAST_STRING}
...
KEYTYPE_BOOL=bool
KEYTYPE_DEPRECATED=(char)|(byte)
KEYTYPE_NUM={KEYTYPE_BOOL}|{KEYTYPE_INT}|{KEYTYPE_FLOAT}|{KEYTYPE_DEPRECATED}
...
<YYINITIAL,END_NAME,END_INT_NAME,START_CONST_FRAG,START_INT_CONST_FRAG,END_INT_CONST> {LINE_COMMENT}
