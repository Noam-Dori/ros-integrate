...
import ros.integrate.pkt.lang.ROSPktLexerAdapter;
...
class ROSPktSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    private static final TextAttributesKey BRACKET =
            createTextAttributesKey("ROSPKT_BRACKET", DefaultLanguageHighlighterColors.BRACKETS);
    static final TextAttributesKey NUMBER =
            createTextAttributesKey("ROSPKT_NUMBER", DefaultLanguageHighlighterColors.NUMBER);
    static final TextAttributesKey STRING =
            createTextAttributesKey("ROSPKT_STRING", DefaultLanguageHighlighterColors.STRING);
    static final TextAttributesKey TYPE =
            createTextAttributesKey("ROSPKT_TYPE", DefaultLanguageHighlighterColors.CLASS_NAME);
    static final TextAttributesKey KEYTYPE =
            createTextAttributesKey("ROSPKT_KEYTYPE", DefaultLanguageHighlighterColors.KEYWORD);
    static final TextAttributesKey NAME =
            createTextAttributesKey("ROSPKT_NAME", DefaultLanguageHighlighterColors.INSTANCE_FIELD);
    static final TextAttributesKey COMMENT =
            createTextAttributesKey("ROSPKT_COMMENT", DefaultLanguageHighlighterColors.LINE_COMMENT);
    private static final TextAttributesKey BAD_CHARACTER =
            createTextAttributesKey("ROSPKT_BAD_CHARACTER", HighlighterColors.BAD_CHARACTER);
    ...
    static final TextAttributesKey SERVICE =
            createTextAttributesKey("ROSPKT_SERVICE_SEPARATOR",
