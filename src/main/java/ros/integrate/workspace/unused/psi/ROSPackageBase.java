...
public abstract class ROSPackageBase extends PsiElementBase implements ROSPackage, Queryable {
    ...
    protected abstract ROSPackage findPackage(String qName);

    protected ROSPackageBase(PsiManager manager, String qualifiedName) {
        myManager = manager;
    ...
    public boolean equals(Object o) {
        return o != null && getClass() == o.getClass()
                && myManager == ((ROSPackageBase)o).myManager
                && myQualifiedName.equals(((ROSPackageBase)o).myQualifiedName);
    }
